...
export class InitialEntities1652637756606 implements MigrationInterface {
    name = 'InitialEntities1652637756606'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "achievement_progress" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "progress" integer NOT NULL, "status" integer NOT NULL, "peopleId" uuid, "levelId" uuid, CONSTRAINT "PK_901cc379a8dbe909f3d617c0da1" PRIMARY KEY ("id"))`);
